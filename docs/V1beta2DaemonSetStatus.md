# Kubernetes::Object::V1beta2DaemonSetStatus
...
**conditions** | [**ARRAY[V1beta2DaemonSetCondition]**](V1beta2DaemonSetCondition.md) | Represents the latest available observations of a DaemonSet&#39;s current state. | [optional] 
