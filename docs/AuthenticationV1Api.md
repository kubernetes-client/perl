...
```perl
use Kubernetes::Object::AuthenticationV1Api;
```
...
# **create_token_review**
> V1TokenReview create_token_review(body => $body, dry_run => $dry_run, include_uninitialized => $include_uninitialized, pretty => $pretty)
...
my $api_instance = Kubernetes::AuthenticationV1Api->new(
...
my $body = Kubernetes::Object::V1TokenReview->new(); # V1TokenReview | 
