# Kubernetes::BatchV1beta1Api

## Load the API package
```perl
use Kubernetes::Object::BatchV1beta1Api;
```
...
> V1beta1CronJob create_namespaced_cron_job(namespace => $namespace, body => $body, include_uninitialized => $include_uninitialized, pretty => $pretty, dry_run => $dry_run)
...
my $api_instance = Kubernetes::BatchV1beta1Api->new(
...
my $body = Kubernetes::Object::V1beta1CronJob->new(); # V1beta1CronJob | 
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->create_namespaced_cron_job: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->delete_collection_namespaced_cron_job: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->delete_namespaced_cron_job: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->get_api_resources: $@\n";
}
```
...
> V1beta1CronJobList list_cron_job_for_all_namespaces(continue => $continue, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, limit => $limit, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->list_cron_job_for_all_namespaces: $@\n";
}
```
...
> V1beta1CronJobList list_namespaced_cron_job(namespace => $namespace, include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->list_namespaced_cron_job: $@\n";
}
```
...
> V1beta1CronJob patch_namespaced_cron_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->patch_namespaced_cron_job: $@\n";
}
```
...
> V1beta1CronJob patch_namespaced_cron_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->patch_namespaced_cron_job_status: $@\n";
}
```
...
> V1beta1CronJob read_namespaced_cron_job(name => $name, namespace => $namespace, pretty => $pretty, exact => $exact, export => $export)
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->read_namespaced_cron_job: $@\n";
}
```
...
> V1beta1CronJob read_namespaced_cron_job_status(name => $name, namespace => $namespace, pretty => $pretty)
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->read_namespaced_cron_job_status: $@\n";
}
```
...
> V1beta1CronJob replace_namespaced_cron_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->replace_namespaced_cron_job: $@\n";
}
```
...
> V1beta1CronJob replace_namespaced_cron_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling BatchV1beta1Api->replace_namespaced_cron_job_status: $@\n";
}
```
