...
```perl
use Kubernetes::Object::RbacAuthorizationV1Api;
```
...
# **create_cluster_role**
> V1ClusterRole create_cluster_role(body => $body, include_uninitialized => $include_uninitialized, pretty => $pretty, dry_run => $dry_run)
...
my $api_instance = Kubernetes::RbacAuthorizationV1Api->new(
...
my $body = Kubernetes::Object::V1ClusterRole->new(); # V1ClusterRole | 
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->create_cluster_role: $@\n";
}
```
...
> V1ClusterRoleBinding create_cluster_role_binding(body => $body, include_uninitialized => $include_uninitialized, pretty => $pretty, dry_run => $dry_run)
...
my $body = Kubernetes::Object::V1ClusterRoleBinding->new(); # V1ClusterRoleBinding | 
my $include_uninitialized = null; # boolean | If true, partially initialized resources are included in the response.
my $pretty = "pretty_example"; # string | If 'true', then the output is pretty printed.
my $dry_run = "dry_run_example"; # string | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->create_cluster_role_binding: $@\n";
}
```
...
> V1Role create_namespaced_role(namespace => $namespace, body => $body, include_uninitialized => $include_uninitialized, pretty => $pretty, dry_run => $dry_run)
...
my $body = Kubernetes::Object::V1Role->new(); # V1Role | 
my $include_uninitialized = null; # boolean | If true, partially initialized resources are included in the response.
my $pretty = "pretty_example"; # string | If 'true', then the output is pretty printed.
my $dry_run = "dry_run_example"; # string | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->create_namespaced_role: $@\n";
}
```
...
> V1RoleBinding create_namespaced_role_binding(namespace => $namespace, body => $body, include_uninitialized => $include_uninitialized, pretty => $pretty, dry_run => $dry_run)
...
my $namespace = "namespace_example"; # string | object name and auth scope, such as for teams and projects
my $body = Kubernetes::Object::V1RoleBinding->new(); # V1RoleBinding | 
my $include_uninitialized = null; # boolean | If true, partially initialized resources are included in the response.
my $pretty = "pretty_example"; # string | If 'true', then the output is pretty printed.
my $dry_run = "dry_run_example"; # string | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->create_namespaced_role_binding: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->delete_cluster_role: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->delete_cluster_role_binding: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->delete_collection_cluster_role: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->delete_collection_cluster_role_binding: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->delete_collection_namespaced_role: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->delete_collection_namespaced_role_binding: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->delete_namespaced_role: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->delete_namespaced_role_binding: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->get_api_resources: $@\n";
}
```
...
# **list_cluster_role**
> V1ClusterRoleList list_cluster_role(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->list_cluster_role: $@\n";
}
```
...
> V1ClusterRoleBindingList list_cluster_role_binding(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->list_cluster_role_binding: $@\n";
}
```
...
> V1RoleList list_namespaced_role(namespace => $namespace, include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->list_namespaced_role: $@\n";
}
```
...
> V1RoleBindingList list_namespaced_role_binding(namespace => $namespace, include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->list_namespaced_role_binding: $@\n";
}
```
...
> V1RoleBindingList list_role_binding_for_all_namespaces(continue => $continue, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, limit => $limit, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->list_role_binding_for_all_namespaces: $@\n";
}
```
...
> V1RoleList list_role_for_all_namespaces(continue => $continue, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, limit => $limit, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->list_role_for_all_namespaces: $@\n";
}
```
...
# **patch_cluster_role**
> V1ClusterRole patch_cluster_role(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->patch_cluster_role: $@\n";
}
```
...
> V1ClusterRoleBinding patch_cluster_role_binding(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->patch_cluster_role_binding: $@\n";
}
```
...
> V1Role patch_namespaced_role(name => $name, namespace => $namespace, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->patch_namespaced_role: $@\n";
}
```
...
> V1RoleBinding patch_namespaced_role_binding(name => $name, namespace => $namespace, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->patch_namespaced_role_binding: $@\n";
}
```
...
# **read_cluster_role**
> V1ClusterRole read_cluster_role(name => $name, pretty => $pretty)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->read_cluster_role: $@\n";
}
```
...
> V1ClusterRoleBinding read_cluster_role_binding(name => $name, pretty => $pretty)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->read_cluster_role_binding: $@\n";
}
```
...
> V1Role read_namespaced_role(name => $name, namespace => $namespace, pretty => $pretty)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->read_namespaced_role: $@\n";
}
```
...
> V1RoleBinding read_namespaced_role_binding(name => $name, namespace => $namespace, pretty => $pretty)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->read_namespaced_role_binding: $@\n";
}
```
...
> V1ClusterRole replace_cluster_role(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->replace_cluster_role: $@\n";
}
```
...
> V1ClusterRoleBinding replace_cluster_role_binding(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->replace_cluster_role_binding: $@\n";
}
```
...
> V1Role replace_namespaced_role(name => $name, namespace => $namespace, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->replace_namespaced_role: $@\n";
}
```
...
> V1RoleBinding replace_namespaced_role_binding(name => $name, namespace => $namespace, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling RbacAuthorizationV1Api->replace_namespaced_role_binding: $@\n";
}
```
