...
```perl
use Kubernetes::Object::AdmissionregistrationV1alpha1Api;
```
...
> V1alpha1InitializerConfiguration create_initializer_configuration(body => $body, include_uninitialized => $include_uninitialized, pretty => $pretty, dry_run => $dry_run)
...
```perl
use Data::Dumper;
use Kubernetes::AdmissionregistrationV1alpha1Api;
my $api_instance = Kubernetes::AdmissionregistrationV1alpha1Api->new(
...
my $body = Kubernetes::Object::V1alpha1InitializerConfiguration->new(); # V1alpha1InitializerConfiguration | 
...
eval { 
    my $result = $api_instance->create_initializer_configuration(body => $body, include_uninitialized => $include_uninitialized, pretty => $pretty, dry_run => $dry_run);
    print Dumper($result);
};
if ($@) {
...
> V1Status delete_collection_initializer_configuration(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->delete_collection_initializer_configuration(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
> V1Status delete_initializer_configuration(name => $name, pretty => $pretty, dry_run => $dry_run, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy, body => $body)
...
eval { 
    my $result = $api_instance->delete_initializer_configuration(name => $name, pretty => $pretty, dry_run => $dry_run, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy, body => $body);
    print Dumper($result);
};
if ($@) {
...
> V1alpha1InitializerConfigurationList list_initializer_configuration(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->list_initializer_configuration(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
> V1alpha1InitializerConfiguration patch_initializer_configuration(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
eval { 
    my $result = $api_instance->patch_initializer_configuration(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run);
    print Dumper($result);
};
if ($@) {
...
> V1alpha1InitializerConfiguration replace_initializer_configuration(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
eval { 
    my $result = $api_instance->replace_initializer_configuration(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run);
    print Dumper($result);
};
if ($@) {
