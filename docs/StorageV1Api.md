...
```perl
use Kubernetes::Object::StorageV1Api;
```
...
> V1StorageClass create_storage_class(body => $body, include_uninitialized => $include_uninitialized, pretty => $pretty, dry_run => $dry_run)
...
my $api_instance = Kubernetes::StorageV1Api->new(
...
my $body = Kubernetes::Object::V1StorageClass->new(); # V1StorageClass | 
...
> V1VolumeAttachment create_volume_attachment(body => $body, include_uninitialized => $include_uninitialized, pretty => $pretty, dry_run => $dry_run)
...
my $body = Kubernetes::Object::V1VolumeAttachment->new(); # V1VolumeAttachment | 
my $include_uninitialized = null; # boolean | If true, partially initialized resources are included in the response.
my $pretty = "pretty_example"; # string | If 'true', then the output is pretty printed.
my $dry_run = "dry_run_example"; # string | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
...
if ($@) {
    warn "Exception when calling StorageV1Api->create_volume_attachment: $@\n";
}
```
...
eval { 
    my $result = $api_instance->delete_collection_storage_class(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
if ($@) {
    warn "Exception when calling StorageV1Api->delete_collection_volume_attachment: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling StorageV1Api->delete_volume_attachment: $@\n";
}
```
...
# **list_storage_class**
> V1StorageClassList list_storage_class(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->list_storage_class(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
> V1VolumeAttachmentList list_volume_attachment(include_uninitialized => $include_uninitialized, pretty => $pretty, continue => $continue, field_selector => $field_selector, label_selector => $label_selector, limit => $limit, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
if ($@) {
    warn "Exception when calling StorageV1Api->list_volume_attachment: $@\n";
}
```
...
# **patch_storage_class**
> V1StorageClass patch_storage_class(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
> V1VolumeAttachment patch_volume_attachment(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling StorageV1Api->patch_volume_attachment: $@\n";
}
```
...
> V1VolumeAttachment patch_volume_attachment_status(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
eval { 
    my $result = $api_instance->patch_volume_attachment_status(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling StorageV1Api->patch_volume_attachment_status: $@\n";
}
```
...
> V1VolumeAttachment read_volume_attachment(name => $name, pretty => $pretty, exact => $exact, export => $export)
...
if ($@) {
    warn "Exception when calling StorageV1Api->read_volume_attachment: $@\n";
}
```
...
> V1VolumeAttachment read_volume_attachment_status(name => $name, pretty => $pretty)
...
eval { 
    my $result = $api_instance->read_volume_attachment_status(name => $name, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling StorageV1Api->read_volume_attachment_status: $@\n";
}
```
...
> V1StorageClass replace_storage_class(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
> V1VolumeAttachment replace_volume_attachment(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
if ($@) {
    warn "Exception when calling StorageV1Api->replace_volume_attachment: $@\n";
}
```
...
> V1VolumeAttachment replace_volume_attachment_status(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run)
...
eval { 
    my $result = $api_instance->replace_volume_attachment_status(name => $name, body => $body, pretty => $pretty, dry_run => $dry_run);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling StorageV1Api->replace_volume_attachment_status: $@\n";
}
```
