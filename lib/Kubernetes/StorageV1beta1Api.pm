...
"Missing the required parameter 'body' when calling create_storage_class"
    ...
    my $_response_object =
      $self->{api_client}->deserialize( 'V1beta1StorageClass', $response );
...
"Missing the required parameter 'body' when calling create_volume_attachment"
    ...
    my $_response_object =
      $self->{api_client}->deserialize( 'V1beta1VolumeAttachment', $response );
    return $_response_object;
}
...
sub list_storage_class {
    ...
    my $_response_object =
      $self->{api_client}->deserialize( 'V1beta1StorageClassList', $response );
    return $_response_object;
}
...
sub list_volume_attachment {
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1VolumeAttachmentList', $response );
    return $_response_object;
}
