...
"Missing the required parameter 'body' when calling create_custom_resource_definition"
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1CustomResourceDefinition', $response );
...
sub delete_custom_resource_definition {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling delete_custom_resource_definition"
        );
    }
...
sub list_custom_resource_definition {
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1CustomResourceDefinitionList', $response );
    return $_response_object;
}
...
sub patch_custom_resource_definition {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling patch_custom_resource_definition"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling patch_custom_resource_definition"
        );
    }
...
sub patch_custom_resource_definition_status {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling patch_custom_resource_definition_status"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling patch_custom_resource_definition_status"
        );
    }
...
sub read_custom_resource_definition_status {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling read_custom_resource_definition_status"
        );
    }
...
sub replace_custom_resource_definition {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_custom_resource_definition"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_custom_resource_definition"
        );
    }
...
sub replace_custom_resource_definition_status {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_custom_resource_definition_status"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_custom_resource_definition_status"
        );
    }
