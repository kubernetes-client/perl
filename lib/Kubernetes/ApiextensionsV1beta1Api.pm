...
#
package Kubernetes::ApiextensionsV1beta1Api;
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    my $params = {
    'body' => {
        data_type => 'V1beta1CustomResourceDefinition',
        description => '',
        required => '1',
    },
    ...
    __PACKAGE__->method_documentation->{ 'create_custom_resource_definition' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CustomResourceDefinition',
        };
}
# @return V1beta1CustomResourceDefinition
#
sub create_custom_resource_definition {
    my ($self, %args) = @_;

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_custom_resource_definition");
    }

    # parse inputs
    my $_resource_path = '/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1CustomResourceDefinition', $response);
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_custom_resource_definition' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_custom_resource_definition {
    my ($self, %args) = @_;
...
# 
# 
# @param string $name name of the CustomResourceDefinition (required)
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
...
# @param V1DeleteOptions $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_custom_resource_definition' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_custom_resource_definition {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_custom_resource_definition");
    }

    # parse inputs
    my $_resource_path = '/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/apiextensions.k8s.io/v1beta1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_custom_resource_definition' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CustomResourceDefinitionList',
        };
}
# @return V1beta1CustomResourceDefinitionList
#
sub list_custom_resource_definition {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1CustomResourceDefinitionList', $response);
    return $_response_object;
}
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_custom_resource_definition' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CustomResourceDefinition',
        };
...
# @return V1beta1CustomResourceDefinition
#
sub patch_custom_resource_definition {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_custom_resource_definition");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_custom_resource_definition");
    }
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_custom_resource_definition_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CustomResourceDefinition',
        };
...
# @return V1beta1CustomResourceDefinition
#
sub patch_custom_resource_definition_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_custom_resource_definition_status");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_custom_resource_definition_status");
    }

    # parse inputs
    my $_resource_path = '/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}/status';
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_custom_resource_definition' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CustomResourceDefinition',
        };
...
# @return V1beta1CustomResourceDefinition
#
sub read_custom_resource_definition {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_custom_resource_definition");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_custom_resource_definition_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CustomResourceDefinition',
        };
...
# @return V1beta1CustomResourceDefinition
#
sub read_custom_resource_definition_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_custom_resource_definition_status");
    }
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_custom_resource_definition' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CustomResourceDefinition',
        };
...
# @return V1beta1CustomResourceDefinition
#
sub replace_custom_resource_definition {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_custom_resource_definition");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_custom_resource_definition");
    }
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_custom_resource_definition_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CustomResourceDefinition',
        };
...
# @return V1beta1CustomResourceDefinition
#
sub replace_custom_resource_definition_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_custom_resource_definition_status");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_custom_resource_definition_status");
    }
