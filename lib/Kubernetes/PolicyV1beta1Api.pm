...
#
package Kubernetes::PolicyV1beta1Api;
...
sub create_namespaced_pod_disruption_budget {
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling create_namespaced_pod_disruption_budget"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling create_namespaced_pod_disruption_budget"
        );
    }
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1PodDisruptionBudget', $response );
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    my $params = {
        'body' => {
            data_type   => 'PolicyV1beta1PodSecurityPolicy',
            description => '',
            required    => '1',
        },
        'include_uninitialized' => {
...
'When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed',
    ...
    __PACKAGE__->method_documentation->{'create_pod_security_policy'} = {
        summary => '',
        params  => $params,
        returns => 'PolicyV1beta1PodSecurityPolicy',
    };
}
...
"Missing the required parameter 'body' when calling create_pod_security_policy"
    ...
    # parse inputs
    my $_resource_path = '/apis/policy/v1beta1/podsecuritypolicies';
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'PolicyV1beta1PodSecurityPolicy', $response );
    return $_response_object;
}
...
sub delete_collection_namespaced_pod_disruption_budget {
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling delete_collection_namespaced_pod_disruption_budget"
        );
    }
...
"Missing the required parameter 'name' when calling delete_pod_security_policy"
    ...
    # parse inputs
    my $_resource_path = '/apis/policy/v1beta1/podsecuritypolicies/{name}';
...
sub list_namespaced_pod_disruption_budget {
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling list_namespaced_pod_disruption_budget"
        );
    }
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1PodDisruptionBudgetList', $response );
    return $_response_object;
}
...
'Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.',
    ...
    __PACKAGE__->method_documentation->{'list_pod_security_policy'} = {
        summary => '',
        params  => $params,
        returns => 'PolicyV1beta1PodSecurityPolicyList',
    };
}
...
sub list_pod_security_policy {
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'PolicyV1beta1PodSecurityPolicyList', $response );
    return $_response_object;
}
...
sub patch_namespaced_pod_disruption_budget_status {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling patch_namespaced_pod_disruption_budget_status"
        );
    }
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling patch_namespaced_pod_disruption_budget_status"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling patch_namespaced_pod_disruption_budget_status"
        );
    }
...
sub read_namespaced_pod_disruption_budget_status {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling read_namespaced_pod_disruption_budget_status"
        );
    }
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling read_namespaced_pod_disruption_budget_status"
        );
    }
...
sub replace_namespaced_pod_disruption_budget {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_namespaced_pod_disruption_budget"
        );
    }
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling replace_namespaced_pod_disruption_budget"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_namespaced_pod_disruption_budget"
        );
    }
