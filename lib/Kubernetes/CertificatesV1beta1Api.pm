...
#
package Kubernetes::CertificatesV1beta1Api;
...
sub create_certificate_signing_request {
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling create_certificate_signing_request"
        );
    }
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1CertificateSigningRequest', $response );
...
sub list_certificate_signing_request {
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1CertificateSigningRequestList', $response );
    return $_response_object;
}
...
sub patch_certificate_signing_request {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling patch_certificate_signing_request"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling patch_certificate_signing_request"
        );
    }
...
# @return V1beta1CertificateSigningRequest
#
sub patch_certificate_signing_request_status {
    my ( $self, %args ) = @_;

    # verify the required parameter 'name' is set
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling patch_certificate_signing_request_status"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling patch_certificate_signing_request_status"
        );
    }
...
sub read_certificate_signing_request {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling read_certificate_signing_request"
        );
    }
...
# @return V1beta1CertificateSigningRequest
#
sub read_certificate_signing_request_status {
    my ( $self, %args ) = @_;
...
sub replace_certificate_signing_request {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_certificate_signing_request"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_certificate_signing_request"
        );
    }
...
sub replace_certificate_signing_request_approval {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_certificate_signing_request_approval"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_certificate_signing_request_approval"
        );
    }
...
sub replace_certificate_signing_request_status {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_certificate_signing_request_status"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_certificate_signing_request_status"
        );
    }
