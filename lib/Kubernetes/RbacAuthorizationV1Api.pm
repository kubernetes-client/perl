...
sub create_cluster_role {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1ClusterRole', $response);
...
sub create_cluster_role_binding {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1/clusterrolebindings';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1ClusterRoleBinding', $response);
    return $_response_object;
}
...
sub create_namespaced_role {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1Role', $response);
    return $_response_object;
}
...
sub create_namespaced_role_binding {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1RoleBinding', $response);
    return $_response_object;
}
...
sub delete_cluster_role {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}';
...
sub delete_cluster_role_binding {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}';
...
sub delete_namespaced_role {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}';
...
sub delete_namespaced_role_binding {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}';
...
sub list_cluster_role {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1ClusterRoleList', $response);
    return $_response_object;
}
...
sub list_cluster_role_binding {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1ClusterRoleBindingList', $response);
    return $_response_object;
}
...
sub list_namespaced_role {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1RoleList', $response);
    return $_response_object;
}
...
sub list_namespaced_role_binding {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1RoleBindingList', $response);
    return $_response_object;
}
