...
#
package Kubernetes::SchedulingV1alpha1Api;
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    my $params = {
    'body' => {
        data_type => 'V1alpha1PriorityClass',
        description => '',
        required => '1',
    },
    ...
    __PACKAGE__->method_documentation->{ 'create_priority_class' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PriorityClass',
        };
}
# @return V1alpha1PriorityClass
#
sub create_priority_class {
    my ($self, %args) = @_;

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_priority_class");
    }

    # parse inputs
    my $_resource_path = '/apis/scheduling.k8s.io/v1alpha1/priorityclasses';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1alpha1PriorityClass', $response);
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_priority_class' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_priority_class {
    my ($self, %args) = @_;
...
# 
# 
# @param string $name name of the PriorityClass (required)
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
...
# @param V1DeleteOptions $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_priority_class' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_priority_class {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_priority_class");
    }

    # parse inputs
    my $_resource_path = '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/scheduling.k8s.io/v1alpha1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_priority_class' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PriorityClassList',
        };
}
# @return V1alpha1PriorityClassList
#
sub list_priority_class {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('V1alpha1PriorityClassList', $response);
    return $_response_object;
}
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_priority_class' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PriorityClass',
        };
...
# @return V1alpha1PriorityClass
#
sub patch_priority_class {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_priority_class");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_priority_class");
    }
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_priority_class' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PriorityClass',
        };
...
# @return V1alpha1PriorityClass
#
sub read_priority_class {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_priority_class");
    }
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_priority_class' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PriorityClass',
        };
...
# @return V1alpha1PriorityClass
#
sub replace_priority_class {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_priority_class");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_priority_class");
    }
