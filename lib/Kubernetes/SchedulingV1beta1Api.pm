...
"Missing the required parameter 'body' when calling create_priority_class"
    ...
    my $_response_object =
      $self->{api_client}->deserialize( 'V1beta1PriorityClass', $response );
...
sub delete_priority_class {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling delete_priority_class"
        );
    }
...
sub list_priority_class {
    ...
    my $_response_object =
      $self->{api_client}->deserialize( 'V1beta1PriorityClassList', $response );
    return $_response_object;
}
...
sub patch_priority_class {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling patch_priority_class"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling patch_priority_class"
        );
    }
...
sub read_priority_class {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling read_priority_class"
        );
    }
...
sub replace_priority_class {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_priority_class"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_priority_class"
        );
    }
