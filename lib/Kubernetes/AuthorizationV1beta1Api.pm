...
'/apis/authorization.k8s.io/v1beta1/namespaces/{namespace}/localsubjectaccessreviews';
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1LocalSubjectAccessReview', $response );
...
"Missing the required parameter 'body' when calling create_self_subject_access_review"
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1SelfSubjectAccessReview', $response );
    return $_response_object;
}
...
"Missing the required parameter 'body' when calling create_self_subject_rules_review"
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1SelfSubjectRulesReview', $response );
    return $_response_object;
}
...
"Missing the required parameter 'body' when calling create_subject_access_review"
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1beta1SubjectAccessReview', $response );
    return $_response_object;
}
