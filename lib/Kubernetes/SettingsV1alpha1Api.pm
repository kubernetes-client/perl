...
#
package Kubernetes::SettingsV1alpha1Api;
...
sub create_namespaced_pod_preset {
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling create_namespaced_pod_preset"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling create_namespaced_pod_preset"
        );
    }
    ...
    my $_response_object =
      $self->{api_client}->deserialize( 'V1alpha1PodPreset', $response );
...
sub delete_collection_namespaced_pod_preset {
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling delete_collection_namespaced_pod_preset"
        );
    }
...
sub delete_namespaced_pod_preset {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling delete_namespaced_pod_preset"
        );
    }
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling delete_namespaced_pod_preset"
        );
    }
...
sub list_namespaced_pod_preset {
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling list_namespaced_pod_preset"
        );
    }
    ...
    my $_response_object =
      $self->{api_client}->deserialize( 'V1alpha1PodPresetList', $response );
    return $_response_object;
}
...
sub patch_namespaced_pod_preset {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling patch_namespaced_pod_preset"
        );
    }
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling patch_namespaced_pod_preset"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling patch_namespaced_pod_preset"
        );
    }
...
sub read_namespaced_pod_preset {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling read_namespaced_pod_preset"
        );
    }
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling read_namespaced_pod_preset"
        );
    }
...
sub replace_namespaced_pod_preset {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_namespaced_pod_preset"
        );
    }
    ...
    unless ( exists $args{'namespace'} ) {
        croak(
"Missing the required parameter 'namespace' when calling replace_namespaced_pod_preset"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_namespaced_pod_preset"
        );
    }
