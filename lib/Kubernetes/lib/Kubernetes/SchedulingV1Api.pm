...
#
package Kubernetes::SchedulingV1Api;
...
sub create_priority_class {
    ...
    # parse inputs
    my $_resource_path = '/apis/scheduling.k8s.io/v1/priorityclasses';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1PriorityClass', $response);
...
sub delete_priority_class {
    ...
    # parse inputs
    my $_resource_path = '/apis/scheduling.k8s.io/v1/priorityclasses/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/scheduling.k8s.io/v1/';
...
sub list_priority_class {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1PriorityClassList', $response);
    return $_response_object;
}
