...
#
package Kubernetes::StorageV1beta1Api;
...
# @param string $field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_csi_driver' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSIDriver',
        };
}
# @return V1beta1CSIDriver
#
sub create_csi_driver {
    my ($self, %args) = @_;

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_csi_driver");
    }

    # parse inputs
    my $_resource_path = '/apis/storage.k8s.io/v1beta1/csidrivers';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1CSIDriver', $response);
...
# @param string $field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_csi_node' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSINode',
        };
}
...
sub create_csi_node {
    ...
    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_csi_node");
    }

    # parse inputs
    my $_resource_path = '/apis/storage.k8s.io/v1beta1/csinodes';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1CSINode', $response);
    return $_response_object;
}
...
# @param string $field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
{
    my $params = {
    'body' => {
        data_type => 'V1beta1VolumeAttachment',
        description => '',
        required => '1',
    },
    'pretty' => {
    ...
    __PACKAGE__->method_documentation->{ 'create_volume_attachment' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1VolumeAttachment',
        };
}
# @return V1beta1VolumeAttachment
#
sub create_volume_attachment {
    my ($self, %args) = @_;

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_volume_attachment");
    }

    # parse inputs
    my $_resource_path = '/apis/storage.k8s.io/v1beta1/volumeattachments';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1VolumeAttachment', $response);
    return $_response_object;
}
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_csi_driver' } = { 
        summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_csi_driver {
    my ($self, %args) = @_;
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_csi_node' } = { 
        summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_csi_node {
    my ($self, %args) = @_;
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_volume_attachment' } = { 
        summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_volume_attachment {
    my ($self, %args) = @_;
...
# 
# 
# @param string $name name of the CSIDriver (required)
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
...
# @param V1DeleteOptions $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_csi_driver' } = { 
        summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_csi_driver {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_csi_driver");
    }

    # parse inputs
    my $_resource_path = '/apis/storage.k8s.io/v1beta1/csidrivers/{name}';
...
# 
# 
# @param string $name name of the CSINode (required)
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
# @param int $grace_period_seconds The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately. (optional)
# @param boolean $orphan_dependents Deprecated: please use the PropagationPolicy, this field will be deprecated in 1.7. Should the dependent objects be orphaned. If true/false, the \&quot;orphan\&quot; finalizer will be added to/removed from the object&#39;s finalizers list. Either this field or PropagationPolicy may be set, but not both. (optional)
...
# @param V1DeleteOptions $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_csi_node' } = { 
        summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
sub delete_csi_node {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_csi_node");
    }

    # parse inputs
    my $_resource_path = '/apis/storage.k8s.io/v1beta1/csinodes/{name}';
...
# 
# 
# @param string $name name of the VolumeAttachment (required)
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
# @param int $grace_period_seconds The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately. (optional)
# @param boolean $orphan_dependents Deprecated: please use the PropagationPolicy, this field will be deprecated in 1.7. Should the dependent objects be orphaned. If true/false, the \&quot;orphan\&quot; finalizer will be added to/removed from the object&#39;s finalizers list. Either this field or PropagationPolicy may be set, but not both. (optional)
...
# @param V1DeleteOptions $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_volume_attachment' } = { 
        summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_volume_attachment {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_volume_attachment");
    }

    # parse inputs
    my $_resource_path = '/apis/storage.k8s.io/v1beta1/volumeattachments/{name}';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_csi_driver' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSIDriverList',
        };
}
...
sub list_csi_driver {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1CSIDriverList', $response);
    return $_response_object;
}
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_csi_node' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSINodeList',
        };
}
...
sub list_csi_node {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1CSINodeList', $response);
    return $_response_object;
}
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_volume_attachment' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1VolumeAttachmentList',
        };
}
# @return V1beta1VolumeAttachmentList
#
sub list_volume_attachment {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1VolumeAttachmentList', $response);
    return $_response_object;
}
...
# @param boolean $force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_csi_driver' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSIDriver',
        };
...
# @return V1beta1CSIDriver
#
sub patch_csi_driver {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_csi_driver");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_csi_driver");
    }
...
# @param boolean $force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_csi_node' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSINode',
        };
...
sub patch_csi_node {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_csi_node");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_csi_node");
    }
...
# @param boolean $force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_volume_attachment' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1VolumeAttachment',
        };
...
# @return V1beta1VolumeAttachment
#
sub patch_volume_attachment {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_volume_attachment");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_volume_attachment");
    }
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_csi_driver' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSIDriver',
        };
...
sub read_csi_driver {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_csi_driver");
    }
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_csi_node' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSINode',
        };
...
sub read_csi_node {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_csi_node");
    }
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_volume_attachment' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1VolumeAttachment',
        };
...
# @return V1beta1VolumeAttachment
#
sub read_volume_attachment {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_volume_attachment");
    }
...
# @param string $field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_csi_driver' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSIDriver',
        };
...
# @return V1beta1CSIDriver
#
sub replace_csi_driver {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_csi_driver");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_csi_driver");
    }
...
# @param string $field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_csi_node' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CSINode',
        };
...
# @return V1beta1CSINode
#
sub replace_csi_node {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_csi_node");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_csi_node");
    }
...
# @param string $field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_volume_attachment' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1VolumeAttachment',
        };
...
# @return V1beta1VolumeAttachment
#
sub replace_volume_attachment {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_volume_attachment");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_volume_attachment");
    }
