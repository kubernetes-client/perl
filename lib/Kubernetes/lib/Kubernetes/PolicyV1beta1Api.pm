...
sub create_pod_security_policy {
    ...
    my $_response_object = $self->{api_client}->deserialize('PolicyV1beta1PodSecurityPolicy', $response);
    return $_response_object;
}
...
sub list_pod_security_policy {
    ...
    my $_response_object = $self->{api_client}->deserialize('PolicyV1beta1PodSecurityPolicyList', $response);
    return $_response_object;
}
