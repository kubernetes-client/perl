...
# @param boolean $force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_certificate_signing_request_status' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CertificateSigningRequest',
        };
...
sub patch_certificate_signing_request_status {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_certificate_signing_request_status");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_certificate_signing_request_status");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_certificate_signing_request_status' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1CertificateSigningRequest',
        };
...
sub read_certificate_signing_request_status {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_certificate_signing_request_status");
    }
