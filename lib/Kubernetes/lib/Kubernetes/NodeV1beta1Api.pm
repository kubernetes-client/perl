...
#
package Kubernetes::NodeV1beta1Api;
...
sub create_runtime_class {
    ...
    # parse inputs
    my $_resource_path = '/apis/node.k8s.io/v1beta1/runtimeclasses';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1RuntimeClass', $response);
...
sub delete_runtime_class {
    ...
    # parse inputs
    my $_resource_path = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/node.k8s.io/v1beta1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_runtime_class' } = { 
        summary => '',
        params => $params,
        returns => 'V1beta1RuntimeClassList',
        };
}
...
sub list_runtime_class {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1RuntimeClassList', $response);
    return $_response_object;
}
