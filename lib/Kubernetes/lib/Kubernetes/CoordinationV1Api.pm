...
#
package Kubernetes::CoordinationV1Api;
...
sub create_namespaced_lease {
    ...
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling create_namespaced_lease");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_namespaced_lease");
    }

    # parse inputs
    my $_resource_path = '/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1Lease', $response);
...
sub delete_collection_namespaced_lease {
    ...
    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling delete_collection_namespaced_lease");
    }
...
sub delete_namespaced_lease {
    ...
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_namespaced_lease");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling delete_namespaced_lease");
    }

    # parse inputs
    my $_resource_path = '/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/coordination.k8s.io/v1/';
...
sub list_lease_for_all_namespaces {
    ...
    # parse inputs
    my $_resource_path = '/apis/coordination.k8s.io/v1/leases';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1LeaseList', $response);
    return $_response_object;
}
...
sub list_namespaced_lease {
    ...
    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling list_namespaced_lease");
    }
...
sub patch_namespaced_lease {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_namespaced_lease");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling patch_namespaced_lease");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_namespaced_lease");
    }
...
sub read_namespaced_lease {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_namespaced_lease");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling read_namespaced_lease");
    }
...
sub replace_namespaced_lease {
    ...
    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_namespaced_lease");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling replace_namespaced_lease");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_namespaced_lease");
    }
