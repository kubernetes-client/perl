...
#
package Kubernetes::NodeV1alpha1Api;
...
# 
# 
# @param V1alpha1RuntimeClass $body  (required)
...
# @param string $field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
{
    my $params = {
    'body' => {
        data_type => 'V1alpha1RuntimeClass',
        description => '',
        required => '1',
    },
    'pretty' => {
    ...
    __PACKAGE__->method_documentation->{ 'create_runtime_class' } = { 
        summary => '',
        params => $params,
        returns => 'V1alpha1RuntimeClass',
        };
}
# @return V1alpha1RuntimeClass
#
sub create_runtime_class {
    my ($self, %args) = @_;

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_runtime_class");
    }

    # parse inputs
    my $_resource_path = '/apis/node.k8s.io/v1alpha1/runtimeclasses';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1alpha1RuntimeClass', $response);
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_runtime_class' } = { 
        summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_runtime_class {
    my ($self, %args) = @_;
...
# 
# 
# @param string $name name of the RuntimeClass (required)
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
...
# @param V1DeleteOptions $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_runtime_class' } = { 
        summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_runtime_class {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_runtime_class");
    }

    # parse inputs
    my $_resource_path = '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/node.k8s.io/v1alpha1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_runtime_class' } = { 
        summary => '',
        params => $params,
        returns => 'V1alpha1RuntimeClassList',
        };
}
# @return V1alpha1RuntimeClassList
#
sub list_runtime_class {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('V1alpha1RuntimeClassList', $response);
    return $_response_object;
}
...
# @param boolean $force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_runtime_class' } = { 
        summary => '',
        params => $params,
        returns => 'V1alpha1RuntimeClass',
        };
...
# @return V1alpha1RuntimeClass
#
sub patch_runtime_class {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_runtime_class");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_runtime_class");
    }
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_runtime_class' } = { 
        summary => '',
        params => $params,
        returns => 'V1alpha1RuntimeClass',
        };
...
# @return V1alpha1RuntimeClass
#
sub read_runtime_class {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_runtime_class");
    }
...
# @param string $field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_runtime_class' } = { 
        summary => '',
        params => $params,
        returns => 'V1alpha1RuntimeClass',
        };
...
# @return V1alpha1RuntimeClass
#
sub replace_runtime_class {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_runtime_class");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_runtime_class");
    }
