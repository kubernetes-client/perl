...
sub create_self_subject_rules_review {
    ...
    # parse inputs
    my $_resource_path = '/apis/authorization.k8s.io/v1/selfsubjectrulesreviews';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1SelfSubjectRulesReview', $response);
    return $_response_object;
}
