...
#
package Kubernetes::Object::V1beta1NonResourceRule;
...
__PACKAGE__->class_documentation({description => 'NonResourceRule holds information that describes a rule for the non-resource',
