...
#
package Kubernetes::Object::V1LocalVolumeSource;
...
__PACKAGE__->class_documentation({description => 'Local represents directly-attached storage with node affinity (Beta feature)',
