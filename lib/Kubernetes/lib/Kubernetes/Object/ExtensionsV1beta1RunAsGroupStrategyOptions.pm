...
#
package Kubernetes::Object::ExtensionsV1beta1RunAsGroupStrategyOptions;
...
__PACKAGE__->class_documentation({description => 'RunAsGroupStrategyOptions defines the strategy type and any options used to create the strategy. Deprecated: use RunAsGroupStrategyOptions from policy API Group instead.',
