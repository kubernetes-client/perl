...
#
package Kubernetes::Object::V1beta1CustomResourceValidation;
...
__PACKAGE__->class_documentation({description => 'CustomResourceValidation is a list of validation methods for CustomResources.',
