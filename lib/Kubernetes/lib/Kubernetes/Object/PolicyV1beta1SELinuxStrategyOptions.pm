...
#
package Kubernetes::Object::PolicyV1beta1SELinuxStrategyOptions;
...
__PACKAGE__->class_documentation({description => 'SELinuxStrategyOptions defines the strategy type and any options used to create the strategy.',
