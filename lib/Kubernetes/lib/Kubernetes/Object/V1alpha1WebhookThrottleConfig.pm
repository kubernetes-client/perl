...
#
package Kubernetes::Object::V1alpha1WebhookThrottleConfig;
...
__PACKAGE__->class_documentation({description => 'WebhookThrottleConfig holds the configuration for throttling events',
