...
#
package Kubernetes::Object::V1alpha1VolumeAttachmentStatus;
...
__PACKAGE__->class_documentation({description => 'VolumeAttachmentStatus is the status of a VolumeAttachment request.',
...
__PACKAGE__->method_documentation({
    'attach_error' => {
        datatype => 'V1alpha1VolumeError',
        base_name => 'attachError',
        description => '',
        format => '',
        read_only => '',
            },
