...
#
package Kubernetes::Object::V1alpha1AuditSinkSpec;
...
__PACKAGE__->class_documentation({description => 'AuditSinkSpec holds the spec for the audit sink',
