...
__PACKAGE__->class_documentation({description => 'Event is a report of an event somewhere in the cluster. It generally denotes some state change in the system.',
                                  class => 'V1beta1Event',
                                  required => [], # TODO
}                                 );
