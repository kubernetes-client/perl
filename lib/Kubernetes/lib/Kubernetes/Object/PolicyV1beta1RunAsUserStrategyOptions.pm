...
#
package Kubernetes::Object::PolicyV1beta1RunAsUserStrategyOptions;
...
__PACKAGE__->class_documentation({description => 'RunAsUserStrategyOptions defines the strategy type and any options used to create the strategy.',
