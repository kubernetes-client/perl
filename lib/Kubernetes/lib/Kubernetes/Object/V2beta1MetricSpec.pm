...
#
package Kubernetes::Object::V2beta1MetricSpec;
...
__PACKAGE__->method_documentation({
    'external' => {
        datatype => 'V2beta1ExternalMetricSource',
        base_name => 'external',
        description => '',
        format => '',
        read_only => '',
    ...
    'object' => {
        datatype => 'V2beta1ObjectMetricSource',
        base_name => 'object',
        description => '',
        format => '',
        read_only => '',
    ...
    'pods' => {
        datatype => 'V2beta1PodsMetricSource',
        base_name => 'pods',
        description => '',
        format => '',
        read_only => '',
    ...
    'resource' => {
        datatype => 'V2beta1ResourceMetricSource',
        base_name => 'resource',
        description => '',
        format => '',
        read_only => '',
