...
#
package Kubernetes::Object::V1beta1NetworkPolicyPort;
...
__PACKAGE__->class_documentation({description => 'DEPRECATED 1.9 - This group version of NetworkPolicyPort is deprecated by networking/v1/NetworkPolicyPort.',
