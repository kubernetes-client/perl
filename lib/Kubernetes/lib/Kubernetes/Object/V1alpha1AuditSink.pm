...
#
package Kubernetes::Object::V1alpha1AuditSink;
...
__PACKAGE__->class_documentation({description => 'AuditSink represents a cluster level audit sink',
...
__PACKAGE__->method_documentation({
    ...
    'spec' => {
        datatype => 'V1alpha1AuditSinkSpec',
        base_name => 'spec',
        description => '',
        format => '',
        read_only => '',
