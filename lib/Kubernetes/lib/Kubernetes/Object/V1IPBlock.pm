...
#
package Kubernetes::Object::V1IPBlock;
...
__PACKAGE__->class_documentation({description => 'IPBlock describes a particular CIDR (Ex. \&quot;192.168.1.1/24\&quot;) that is allowed to the pods matched by a NetworkPolicySpec&#39;s podSelector. The except entry describes CIDRs that should not be included within this rule.',
                                  class => 'V1IPBlock',
                                  required => [], # TODO
}                                 );
