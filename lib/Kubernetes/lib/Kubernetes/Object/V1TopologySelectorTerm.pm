...
#
package Kubernetes::Object::V1TopologySelectorTerm;
...
__PACKAGE__->method_documentation({
    'match_label_expressions' => {
        datatype => 'ARRAY[V1TopologySelectorLabelRequirement]',
        base_name => 'matchLabelExpressions',
...
__PACKAGE__->openapi_types( {
    'match_label_expressions' => 'ARRAY[V1TopologySelectorLabelRequirement]'
} );
