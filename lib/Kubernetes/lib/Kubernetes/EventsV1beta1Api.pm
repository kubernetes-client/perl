...
#
package Kubernetes::EventsV1beta1Api;
...
sub create_namespaced_event {
    ...
    # parse inputs
    my $_resource_path = '/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1Event', $response);
...
sub delete_namespaced_event {
    ...
    # parse inputs
    my $_resource_path = '/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/events.k8s.io/v1beta1/';
...
sub list_event_for_all_namespaces {
    ...
    # parse inputs
    my $_resource_path = '/apis/events.k8s.io/v1beta1/events';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1EventList', $response);
    return $_response_object;
}
