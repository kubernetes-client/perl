...
#
package Kubernetes::NetworkingV1beta1Api;
...
# @param string $field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
{
    ...
    'body' => {
        data_type => 'NetworkingV1beta1Ingress',
        description => '',
        required => '1',
    },
    'pretty' => {
    ...
    __PACKAGE__->method_documentation->{ 'create_namespaced_ingress' } = { 
        summary => '',
        params => $params,
        returns => 'NetworkingV1beta1Ingress',
        };
}
...
sub create_namespaced_ingress {
    ...
    # parse inputs
    my $_resource_path = '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses';
    ...
    my $_response_object = $self->{api_client}->deserialize('NetworkingV1beta1Ingress', $response);
...
sub delete_namespaced_ingress {
    ...
    # parse inputs
    my $_resource_path = '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/networking.k8s.io/v1beta1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_ingress_for_all_namespaces' } = { 
        summary => '',
        params => $params,
        returns => 'NetworkingV1beta1IngressList',
        };
}
...
sub list_ingress_for_all_namespaces {
    ...
    # parse inputs
    my $_resource_path = '/apis/networking.k8s.io/v1beta1/ingresses';
    ...
    my $_response_object = $self->{api_client}->deserialize('NetworkingV1beta1IngressList', $response);
    return $_response_object;
}
...
sub patch_namespaced_ingress_status {
    ...
    # parse inputs
    my $_resource_path = '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status';
