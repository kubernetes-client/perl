...
#
package Kubernetes::AdmissionregistrationV1alpha1Api;
...
sub create_initializer_configuration {
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling create_initializer_configuration"
        );
    }
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1alpha1InitializerConfiguration', $response );
...
sub delete_initializer_configuration {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling delete_initializer_configuration"
        );
    }
...
sub list_initializer_configuration {
    ...
    my $_response_object = $self->{api_client}
      ->deserialize( 'V1alpha1InitializerConfigurationList', $response );
    return $_response_object;
}
...
sub patch_initializer_configuration {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling patch_initializer_configuration"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling patch_initializer_configuration"
        );
    }
...
sub read_initializer_configuration {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling read_initializer_configuration"
        );
    }
...
sub replace_initializer_configuration {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_initializer_configuration"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_initializer_configuration"
        );
    }
