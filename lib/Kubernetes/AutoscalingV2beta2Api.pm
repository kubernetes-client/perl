...
#
package Kubernetes::AutoscalingV2beta2Api;
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    ...
    'body' => {
        data_type => 'V2beta2HorizontalPodAutoscaler',
        description => '',
        required => '1',
    },
    ...
    __PACKAGE__->method_documentation->{ 'create_namespaced_horizontal_pod_autoscaler' } = { 
    	summary => '',
        params => $params,
        returns => 'V2beta2HorizontalPodAutoscaler',
        };
}
...
sub create_namespaced_horizontal_pod_autoscaler {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers';
    ...
    my $_response_object = $self->{api_client}->deserialize('V2beta2HorizontalPodAutoscaler', $response);
...
sub delete_namespaced_horizontal_pod_autoscaler {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v2beta2/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_horizontal_pod_autoscaler_for_all_namespaces' } = { 
    	summary => '',
        params => $params,
        returns => 'V2beta2HorizontalPodAutoscalerList',
        };
}
...
sub list_horizontal_pod_autoscaler_for_all_namespaces {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v2beta2/horizontalpodautoscalers';
    ...
    my $_response_object = $self->{api_client}->deserialize('V2beta2HorizontalPodAutoscalerList', $response);
    return $_response_object;
}
...
sub patch_namespaced_horizontal_pod_autoscaler_status {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status';
