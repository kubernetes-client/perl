...
#
package Kubernetes::ApiregistrationV1Api;
...
sub create_api_service {
    ...
    # parse inputs
    my $_resource_path = '/apis/apiregistration.k8s.io/v1/apiservices';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1APIService', $response);
...
sub delete_api_service {
    ...
    # parse inputs
    my $_resource_path = '/apis/apiregistration.k8s.io/v1/apiservices/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/apiregistration.k8s.io/v1/';
...
sub list_api_service {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1APIServiceList', $response);
    return $_response_object;
}
...
# @param string $dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_api_service_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1APIService',
        };
...
# @return V1APIService
#
sub patch_api_service_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_api_service_status");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_api_service_status");
    }

    # parse inputs
    my $_resource_path = '/apis/apiregistration.k8s.io/v1/apiservices/{name}/status';
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_api_service_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1APIService',
        };
...
# @return V1APIService
#
sub read_api_service_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_api_service_status");
    }
