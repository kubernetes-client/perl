...
sub create_namespaced_lease {
    ...
    # parse inputs
    my $_resource_path = '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1Lease', $response);
...
sub delete_namespaced_lease {
    ...
    # parse inputs
    my $_resource_path = '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}';
...
sub list_lease_for_all_namespaces {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1LeaseList', $response);
    return $_response_object;
}
