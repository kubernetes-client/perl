...
sub create_audit_sink {
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling create_audit_sink"
        );
    }
    ...
    my $_response_object =
      $self->{api_client}->deserialize( 'V1alpha1AuditSink', $response );
...
sub list_audit_sink {
    ...
    my $_response_object =
      $self->{api_client}->deserialize( 'V1alpha1AuditSinkList', $response );
    return $_response_object;
}
...
sub patch_audit_sink {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling patch_audit_sink"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling patch_audit_sink"
        );
    }
...
sub read_audit_sink {
    ...
    unless ( exists $args{'name'} ) {
        croak(
            "Missing the required parameter 'name' when calling read_audit_sink"
        );
    }
...
sub replace_audit_sink {
    ...
    unless ( exists $args{'name'} ) {
        croak(
"Missing the required parameter 'name' when calling replace_audit_sink"
        );
    }
    ...
    unless ( exists $args{'body'} ) {
        croak(
"Missing the required parameter 'body' when calling replace_audit_sink"
        );
    }
