...
#
package Kubernetes::Object::ExtensionsV1beta1DeploymentRollback;
...
__PACKAGE__->class_documentation({description => 'DEPRECATED. DeploymentRollback stores the information required to rollback a deployment.',
