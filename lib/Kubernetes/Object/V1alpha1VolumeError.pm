...
#
package Kubernetes::Object::V1alpha1VolumeError;
...
__PACKAGE__->class_documentation({description => 'VolumeError captures an error encountered during a volume operation.',
