...
#
package Kubernetes::Object::PolicyV1beta1RunAsGroupStrategyOptions;
...
__PACKAGE__->class_documentation({description => 'RunAsGroupStrategyOptions defines the strategy type and any options used to create the strategy.',
...
__PACKAGE__->method_documentation({
    'ranges' => {
    	datatype => 'ARRAY[PolicyV1beta1IDRange]',
    	base_name => 'ranges',
