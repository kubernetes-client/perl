...
__PACKAGE__->class_documentation({description => 'PriorityClass defines mapping from a priority class name to the priority integer value. The value can be any valid integer.',
