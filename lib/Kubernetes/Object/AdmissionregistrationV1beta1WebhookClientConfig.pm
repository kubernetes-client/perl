...
#
package Kubernetes::Object::AdmissionregistrationV1beta1WebhookClientConfig;
...
__PACKAGE__->class_documentation({description => 'WebhookClientConfig contains the information to make a TLS connection with the webhook',
...
__PACKAGE__->method_documentation({
    ...
    'service' => {
    	datatype => 'AdmissionregistrationV1beta1ServiceReference',
    	base_name => 'service',
    	description => '',
    	format => '',
    	read_only => '',
